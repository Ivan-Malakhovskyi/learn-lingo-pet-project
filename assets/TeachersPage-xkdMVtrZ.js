import{a as j,r as l,j as t,L as Y,u as r,b as I,c as _,s as K,f as q}from"./index-BYxIqKWB.js";import{s as H,a as J,T as Q,b as V,E as X}from"./TeachersListItem-BdL_WfH7.js";import{S as Z,C as N}from"./SharedLayout.styled-CJkVTWUE.js";const E=["English","Spanish","French","German","Mandarin Chinese","Italian","Korean","Vietnamese"],z=["A1 Beginner","A2 Elementary","B1 Intermediate","B2 Upper-Intermediate","C1 Advanced","C2 Proficient"],D=[0,5,10,15,20,25,30,35,40],O=e=>e.filters;function ee(e,n){const{language:i,level:c,price:p}=n;return e.filter(o=>!(i&&!o.languages.includes(i)||c&&!o.levels.includes(c)||p&&o.price_per_hour>Number(p)))}const te=()=>{const{language:e,level:n,price:i}=j(O),c=j(H),p=j(J),[o,x]=l.useState([]),[m,f]=l.useState(!1);l.useEffect(()=>{if(e||n||i){const h=ee(c,{language:e,level:n,price:i});x(h)}else x(c)},[e,n,c,i]);const b=()=>{f(!m)},v=e||n||i;return t.jsxs(t.Fragment,{children:[p&&t.jsx(Y,{}),t.jsx(Q,{children:t.jsx("ul",{children:o.length>0&&!p?o.map(h=>t.jsx(V,{close:b,teacher:h},h.id)):v&&t.jsx(X,{children:"No teachers found, try change filters 😢"})})})]})},u=(e,n)=>({...e,[n]:!e[n]});r.div`
  position: absolute;
  z-index: 100;
  top: calc(100% + 4px);
  left: 0;
